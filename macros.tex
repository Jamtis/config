...
\declarecommand{\smashedunderbrace}[2]{\smash{\underbrace{#1}_{#2}}\vphantom{#1}}
\declarecommand{\smashedoverbrace}[2]{\smash{\overbrace{#1}_{#2}}\vphantom{#1}}
...
{
    \let\originalleq\leq
    \declarecommand{\leq}[1][]{\originalleq_{\mathsf{#1}}}
    \declarecommand{\l}[1][]{<_{\mathsf{#1}}}
    \let\originalgeq\geq
    \declarecommand{\geq}[1][]{\originalgeq_{\mathsf{#1}}}
    \declarecommand{\g}[1][]{>_{\mathsf{#1}}}
}

% Randomness
\declarecommand{\Pr}[2][]{\operatorname{Pr}_{#1}\pars{#2}}
\declarecommand{\Ex}[2][]{\operatorname{Ex}_{#1}\pars{#2}}
\declarecommand{\Var}[2][]{\operatorname{Var}_{#1}\pars{#2}}
