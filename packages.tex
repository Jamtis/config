...
\else
    \def\citestyle{authoryear}
\fi
\usepackage[citestyle=\citestyle,style=numeric,giveninits=true,backend=\backend,isbn=false,doi=false,dateabbrev=false,url=false,natbib=true]{biblatex}
